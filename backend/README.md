...
## Project Structure
    ...
    ├── testapiautoconnecto_56752  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_56752`
...
2. Clone this repo and `cd testapiautoconnecto_56752`
